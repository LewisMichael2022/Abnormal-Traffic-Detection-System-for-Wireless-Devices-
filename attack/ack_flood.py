...
target_ip = "172.20.10.15"#"203.0.113.123"# #要攻擊的server IP
target_port = 63214 #要攻擊的server port
# ############################################################

print(f"Sending TCP ACK flood to {target_ip}:{target_port}...")
